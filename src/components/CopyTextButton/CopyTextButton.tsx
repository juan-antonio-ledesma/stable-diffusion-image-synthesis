...
export default function CopyTextButton({ text }: Props) {
  ...
  const handleCopyText = () => {
    ...
    setTimeout(() => setIsVisibleTooltip(false), 2500)
  }
  ...
  return (
    ...
    >
      ...
      <span
        className={`copyTextButton-tooltip${
          isVisibleTooltip ? ' is-visible' : ''
        }`}
        aria-hidden={isVisibleTooltip ? 'false' : 'true'}
      >
        Copied!
      </span>
    </button>
